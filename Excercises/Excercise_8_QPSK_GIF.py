...
ani = FuncAnimation(fig, update, frames=200, blit=True, interval=10)  # frames = length of GIF, interval = time between frames in milliseconds

ani.save('QPSK_constellation.gif', writer=PillowWriter(fps=10))  # Save as animated GIF, fps = frames per second, save in the same directory as the script
